...
namespace DGC.Function
{
    public class Certificate
    {
        ...
        public async Task<IActionResult> GetCertificateByAutAndCf(
            [HttpTrigger(AuthorizationLevel.Anonymous, "post", Route = "v1/certificate/citizen/io")]
            HttpRequest req,
            ILogger log,
            ExecutionContext context)
        {
            log.LogInformation("C# HTTP trigger function processed Certificate/getCertificateByAutAndCF/GetCertificateByAutAndCf");
        ...
        [OpenApiResponseWithBody(statusCode: HttpStatusCode.OK, contentType: "text/plain", bodyType: typeof(string),
                                 Description = "The OK response")]
        public async Task<IActionResult> ManagePreviousCertificates(
            [HttpTrigger(AuthorizationLevel.Anonymous, "post", Route = "v1/certificate/citizen/io/refresh")]
            HttpRequest req,
            ILogger log,
            ExecutionContext context)
        {
            log.LogInformation("C# HTTP trigger function processed Refresh/managePreviousCertificates/ManagePreviousCertificates");
